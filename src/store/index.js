...
export default new Vuex.Store({
  ...
  actions: {
    ...
    getDikisForm({commit}){
      return axios
      .get('http://localhost:8080/api/getDikisGunlukImalatRaporu/dikisGunlukImalatRaporu')
      .catch(error => console.log(error))
      .then(({data}) => {
    ...
    getHookandLoopForm({commit}){
      return axios
      .get('http://localhost:8080/api/gethookAndLoopGunlukImalat/HookAndLoopGunlukImalat')
      .catch(error => console.log(error))
      .then(({data}) => {
